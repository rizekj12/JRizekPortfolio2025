    ...
    return (
        <header id="hero" ref={heroRef} className={`${styles.hero} ${inView ? styles.inView : ""}`} aria-label="Hero">
            ...
            <div className={styles.heroCenter}>
                <div className={`${styles.heroInner} ${styles.fadeItem}`}>
                <h1 className={styles.heroName}>Joshua Rizek</h1>
                <img
                ...
                <div className={styles.topStats}>
                    <div className={styles.stat}>
                        <span className={styles.statPrimary}>5+ Years</span>
                        <span className={styles.statLabel}>Experience</span>
                    </div>
                    <span className={styles.sep} />
                    <div className={styles.stat}>
                        <span className={styles.statPrimary}>Certified</span>
                        <span className={styles.statLabel}>Scrum Master</span>
                    </div>
                    <span className={styles.sep} />
                    <div className={styles.stat}>
                        <span className={styles.statPrimary}>Secret</span>
